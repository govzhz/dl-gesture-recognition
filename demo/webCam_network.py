...
class GestureRec(object):
    ...
    def run(self):
        ...
        while self._cap_video.isOpened():
            ...
            ret, frame = self._cap_video.read()
            frameCount += 1
            cv2.imwrite("%06d.jpg" % frameCount, frame)
...
if __name__ == "__main__":
    ...
    cap = GestureRec(server_address=args.server_address, upload_size=UPLOAD_SIZE, pool_size=POOL_SIZE, device_index=args.device)
    cap.run()
